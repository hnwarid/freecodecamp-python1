...
print(add_time("11:43 PM", "24:20", "tueSday"))    # 12:03 AM, Thursday (2 days later)  #make it 12:00 AM 

print(add_time("3:30 PM", "2:12"))              # 5:42 PM
print(add_time("11:55 AM", "3:12"))             # 3:07 PM
print(add_time("9:15 PM", "5:30"))              # 2:45 AM (next day)
print(add_time("11:40 AM", "0:25"))             # 12:05 PM                          #FAILURE PM not AM
print(add_time("2:59 AM", "24:00"))             # 2:59 AM (next day)
print(add_time("11:59 PM", "24:05"))            # 12:04 AM (2 days later)           #FAILURE 12:00 AM not 00:00 AM
...
print(add_time("11:59 PM", "24:05", "Wednesday"))# 12:04 AM, Friday (2 days later)  #FAILURE
